...
<head>
    ...
    <title>Personal Care Assistance</title>
</head>
<body>
    <!-- Start Nav Bar -->
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item carousel-one active">
            <div class="text-box">
              ...
              <p>•	Bathing and grooming assistance <br>
                •	Dressing and toileting support <br>
                •	Mobility and transfer assistance <br>
...
// Connect to the database
        ...
        $query = "SELECT * FROM nurse WHERE service_id = 2" ;
