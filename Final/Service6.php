...
<head>
    ...
    <title>Rehabilitation Support</title>
</head>
<body>
    <!-- Start Nav Bar -->
      ...
      <div id="main-slider" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item carousel-one active">
            <div class="text-box">
              <h2>Rehabilitation Support</h2>
              <p>•	Physical therapy exercises <br>
                •	Occupational therapy assistance <br>
                •	Speech therapy support <br>
                •	Stroke or injury recovery care <br>
...
// Connect to the database
        ...
        $query = "SELECT * FROM nurse WHERE service_id = 6" ;
