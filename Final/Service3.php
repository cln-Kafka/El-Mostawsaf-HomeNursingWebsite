...
<head>
    ...
    <title>Companion and Emotional Support</title>
</head>
<body>
    <!-- Start Nav Bar -->
      ...
      <div id="main-slider" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item carousel-one active">
            <div class="text-box" style=" left: 25%;">
              <h2>Companion and Emotional Support</h2>
              <p>•	Companionship and conversation <br>
                •	Social engagement and activities <br>
...
// Connect to the database
        ...
        $query = "SELECT * FROM nurse WHERE service_id = 3" ;
