      ...
      <div id="main-slider" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item carousel-one active">
            <div class="text-box">
              <h2>Respite Care</h2>
              <p>•	Temporary relief for family caregivers <br>
                •	In-home respite care services <br>
                •	Assistance during vacations or personal time off <br>
...
// Connect to the database
        ...
        $query = "SELECT * FROM nurse WHERE service_id = 5" ;
